...
from diabetes_charts import make_diabetes_map, make_diabetes_charts_altair
from obesity_prevalence_plot import chart_ob_pre
...
div[class*="Slider"] > label > div[data-testid="stMarkdownContainer"] > p {
    ...
    age = st.number_input('Enter your age', 18, 90, 18)
    ...
    height = st.number_input('Enter your height in Centimetres:', 0, 230, 170)
    weight = st.number_input('Enter your weight in Kilograms:', 0, 300, 70)
...
def page_results(preds_val_xgb):
    ...
    if preds_val_xgb > 0:
        ...
        tab1, tab2 = st.tabs(["Learn More about Diabetes", "Learn More about Obesity"])
        with tab1:
            page_facts_diabetes()
...
def page_facts_diabetes():
    ...
    map_d = make_diabetes_map()
    charts = make_diabetes_charts_altair()

    st.plotly_chart(map_d)
